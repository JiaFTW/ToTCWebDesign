...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
	...
	<div class="navbar">
		<ul>
			<div class="nav-left">
				...
				<li><a href="home2.php"><h1>Taste of the Caribbean<h1></a></li>
			</div>
			<div class="nav-right">
  ...
  <h2>Your Cart</h2>
    <div class="cart-container">
        <?php if (empty($cart)): ?>
            <p>Your cart is empty. <a class="a" href="menu2.php">Browse our menu</a> to add delicious items!</p>
        <?php else: ?>
        ...
        <?php endif; ?>
        <form action="clear_cart2.php" method="POST">
